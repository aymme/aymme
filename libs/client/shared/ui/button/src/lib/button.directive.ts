...
export const ButtonColorValues: Record<ButtonColor, string> = {
  basic:
    'py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-transparent dark:hover:bg-slate-800 dark:border-blend-50 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800',
  primary:
  ...
  secondary:
    'py-[.688rem] px-4 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-200 font-semibold text-blue-500 hover:text-white hover:bg-blue-500 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:border-blend-50 dark:hover:border-blue-500',
  danger:
