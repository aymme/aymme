...
CREATE TABLE "Collection" (
    ...
    CONSTRAINT "Collection_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "Header" (
    ...
    CONSTRAINT "Header_endpointId_fkey" FOREIGN KEY ("endpointId") REFERENCES "Endpoint" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
);
